...
def contradiction(
    ...
    **kwargs
    ...
    Returns 0.0 if they contradict, 1.0 if they don't contradict.
    ...
    Returns:
        0.0 if contradiction detected, 1.0 otherwise
    """
    try:
    ...
    try:
        ...
        # Inverted: if contradiction (yes), return 0.0; if no contradiction (no), return 1.0
